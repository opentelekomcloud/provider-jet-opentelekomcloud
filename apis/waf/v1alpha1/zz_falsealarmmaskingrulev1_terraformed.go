...
func (mg *FalsealarmmaskingRuleV1) GetTerraformResourceType() string {
	return "opentelekomcloud_waf_falsealarmmasking_rule_v1"
}
...
// LateInitialize this FalsealarmmaskingRuleV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FalsealarmmaskingRuleV1) LateInitialize(attrs []byte) (bool, error) {
	params := &FalsealarmmaskingRuleV1Parameters{}
