...
func (mg *AlarmNotificationV1) GetTerraformResourceType() string {
	return "opentelekomcloud_waf_alarm_notification_v1"
}
...
// LateInitialize this AlarmNotificationV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AlarmNotificationV1) LateInitialize(attrs []byte) (bool, error) {
	params := &AlarmNotificationV1Parameters{}
