...
func (mg *CcattackprotectionRuleV1) GetTerraformResourceType() string {
	return "opentelekomcloud_waf_ccattackprotection_rule_v1"
}
...
// LateInitialize this CcattackprotectionRuleV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CcattackprotectionRuleV1) LateInitialize(attrs []byte) (bool, error) {
	params := &CcattackprotectionRuleV1Parameters{}
