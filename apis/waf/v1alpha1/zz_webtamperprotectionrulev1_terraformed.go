...
func (mg *WebtamperprotectionRuleV1) GetTerraformResourceType() string {
	return "opentelekomcloud_waf_webtamperprotection_rule_v1"
}
...
// LateInitialize this WebtamperprotectionRuleV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *WebtamperprotectionRuleV1) LateInitialize(attrs []byte) (bool, error) {
	params := &WebtamperprotectionRuleV1Parameters{}
