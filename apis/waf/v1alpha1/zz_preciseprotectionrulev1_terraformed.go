...
func (mg *PreciseprotectionRuleV1) GetTerraformResourceType() string {
	return "opentelekomcloud_waf_preciseprotection_rule_v1"
}
...
// LateInitialize this PreciseprotectionRuleV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PreciseprotectionRuleV1) LateInitialize(attrs []byte) (bool, error) {
	params := &PreciseprotectionRuleV1Parameters{}
