...
func (mg *BackupV1) GetTerraformResourceType() string {
	return "opentelekomcloud_csbs_backup_v1"
}
...
// GetID returns ID of underlying Terraform resource of this BackupV1
...
// LateInitialize this BackupV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *BackupV1) LateInitialize(attrs []byte) (bool, error) {
	params := &BackupV1Parameters{}
