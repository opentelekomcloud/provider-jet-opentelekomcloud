...
// GetItems of this BmsServerV2List.
func (l *BmsServerV2List) GetItems() []resource.Managed {
...
// GetItems of this BmsTagsV2List.
func (l *BmsTagsV2List) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
