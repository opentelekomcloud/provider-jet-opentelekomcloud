...
func (mg *ProtectedInstanceV1) GetTerraformResourceType() string {
	return "opentelekomcloud_sdrs_protected_instance_v1"
}
...
// LateInitialize this ProtectedInstanceV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ProtectedInstanceV1) LateInitialize(attrs []byte) (bool, error) {
	params := &ProtectedInstanceV1Parameters{}
